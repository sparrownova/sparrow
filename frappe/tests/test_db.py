...
class TestDB(FrappeTestCase):
	...
	def test_modify_query(self):
		...
		query = (
			'select locate(".io", "sparrownova.com"), locate("3", cast(3 as varchar)), locate("3", 3::varchar)'
		)
		self.assertEqual(
			'select strpos( "sparrownova.com", ".io"), strpos( cast(3 as varchar), "3"), strpos( 3::varchar, "3")',
			modify_query(query),
		)
