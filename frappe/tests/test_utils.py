...
class TestValidationUtils(FrappeTestCase):
	def test_valid_url(self):
		...
		self.assertTrue(validate_url("http://sparrownova.com", throw=True))
		...
		self.assertFalse(
			validate_url("bolo://sparrownova.com", valid_schemes=("http", "https", "ftp", "ftps"))
		)
		self.assertRaises(
			frappe.ValidationError, validate_url, "gopher://sparrownova.com", valid_schemes="https", throw=True
		)
