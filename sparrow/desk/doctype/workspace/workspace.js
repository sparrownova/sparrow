...
sparrow.ui.form.on("Workspace", {
	setup: function () {
		sparrow.meta.get_field("Workspace Link", "only_for").no_default = true;
	},
	...
	refresh: function (frm) {
		...
		let url = `/app/${
			frm.doc.public
				? sparrow.router.slug(frm.doc.title)
				: "private/" + sparrow.router.slug(frm.doc.title)
		}`;
		frm.sidebar
		...
		if (
			...
			(frm.doc.public &&
				!frm.has_perm("write") &&
				!sparrow.user.has_role("Workspace Manager"))
		) {
