...
class TestWorkspace(SparrowTestCase):
	def setUp(self):
		create_module("Test Module")

	def tearDown(self):
		sparrow.db.delete("Workspace", {"module": "Test Module"})
		sparrow.db.delete("DocType", {"module": "Test Module"})
		sparrow.delete_doc("Module Def", "Test Module")
	...
	# 	if sparrow.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = sparrow.get_doc(
		{"doctype": "Module Def", "module_name": module_name, "app_name": "sparrow"}
	)
...
def create_workspace(**args):
	workspace = sparrow.new_doc("Workspace")
