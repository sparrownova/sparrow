...
def pass_context(f):
	...
	def _func(ctx, *args, **kwargs):
		...
		try:
			ret = f(sparrow._dict(ctx.obj), *args, **kwargs)
		except sparrow.exceptions.SiteNotSpecifiedError as e:
			click.secho(str(e), fg="yellow")
			sys.exit(1)
		except sparrow.exceptions.IncorrectSitePath:
...
def get_site(context, raise_err=True):
	try:
		...
		if raise_err:
			raise sparrow.SiteNotSpecifiedError
		return None
...
def get_commands():
	...
	clickable_link = "\x1b]8;;https://sparrowframework.com/docs\asparrowframework.com\x1b]8;;\a"
	all_commands = (
