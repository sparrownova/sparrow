...
def delete_test_data():
	...
	for doctype in doctypes:
		if sparrow.db.table_exists(doctype):
			sparrow.db.delete(doctype)
			sparrow.delete_doc("DocType", doctype, force=True)
...
def add_links_in_child_tables():
	child_table_with_link_to_doctype_a = sparrow.get_doc(
	...
	child_table_with_link_to_doctype_b = sparrow.get_doc(
