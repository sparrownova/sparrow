...
import sparrow
from sparrow.modules.patch_handler import get_all_patches
from sparrow.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = sparrow._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.default_user_input = sparrow._dict(
			{
				"title": "Test App",
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(sparrow.get_app_path("sparrow", "patches.txt")))
		...
		expected_patch = "sparrow.core.doctype.user.patches.delete_all_users"
