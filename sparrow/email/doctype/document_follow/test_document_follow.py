...
import sparrow
import sparrow.desk.form.document_follow as document_follow
from sparrow.desk.form.assign_to import add
from sparrow.desk.form.document_follow import get_document_followed_by_user
from sparrow.desk.form.utils import add_comment
from sparrow.desk.like import toggle_like
...
class TestDocumentFollow(SparrowTestCase):
	...
	def tearDown(self):
		...
		sparrow.db.delete("Document Follow")
	...
	doc = sparrow.get_doc(
		{
			...
			"doc.starts_on": sparrow.utils.now(),
			"doc.ends_on": sparrow.utils.add_days(sparrow.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if sparrow.db.exists("User", "test@docsub.com"):
		doc = sparrow.delete_doc("User", "test@docsub.com")
	doc = sparrow.new_doc("User")
