...
def get_auto_email_report():
	if not sparrow.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = sparrow.get_doc(
			dict(
		...
		auto_email_report = sparrow.get_doc("Auto Email Report", "Permitted Documents For User")
