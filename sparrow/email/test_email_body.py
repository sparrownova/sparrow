...
import sparrow
from sparrow import safe_decode
from sparrow.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from sparrow.email.email_body import (
	get_email,
	get_header,
...
<div>
	...
	<img embed="assets/sparrow/images/sparrow-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/sparrow/images/sparrow-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = sparrow.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="sparrow-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/sparrow/images/sparrow-favicon.svg" alt="test" />
...
From: test1_@shopper.com
Reply-To: test2_@shopper.com
"""
			+ text_content_bytes
		)
