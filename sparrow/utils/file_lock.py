...
Use `sparrow.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import sparrow
from sparrow.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in sparrow.local.locked_documents:
		doc.unlock()
