...
from sparrow.utils import add_to_date, get_datetime, getdate
...
def get_user_date_format():
	if getattr(sparrow.local, "user_date_format", None) is None:
		sparrow.local.user_date_format = sparrow.defaults.get_global_default("date_format") or "yyyy-mm-dd"

	return sparrow.local.user_date_format
...
def datetime_in_user_format(date_time):
	...
	from sparrow.utils import formatdate
