...
from sparrow.database.postgres.schema import PostgresTable
from sparrow.database.utils import EmptyQueryValues, LazyDecode
from sparrow.utils import cstr, get_table_name
...
class PostgresExceptionUtil:
	...
	def is_statement_timeout(e):
		return PostgresDatabase.is_timedout(e) or isinstance(e, sparrow.QueryTimeoutError)
		...
		return [
			...
			where table_catalog='{}'
				...
				and table_schema='{}'""".format(
					sparrow.conf.db_name, sparrow.conf.get("db_schema", "public")
				)
			)
		]
