...
import sparrow
from sparrow.utils import cstr, escape_html, get_request_site_address, now
...
def get_context(context):
	...
	blog_settings = sparrow.get_doc("Blog Settings", "Blog Settings")
