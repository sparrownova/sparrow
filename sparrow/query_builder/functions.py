...
import sparrow
from sparrow.query_builder.custom import GROUP_CONCAT, MATCH, STRING_AGG, TO_TSVECTOR
from sparrow.query_builder.utils import ImportMapper, db_type_is
...
class Cast_(Function):
	def __init__(self, value, as_type, alias=None):
		if sparrow.db.db_type == "mariadb" and (
