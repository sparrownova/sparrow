import sparrow
from sparrow.desk.doctype.notification_log.notification_log import make_notification_logs
...
def execute():
	...
	sparrow.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = sparrow.qb.DocType("User").as_("user")
	user_role_doctype = sparrow.qb.DocType("Has Role").as_("user_role")
	return (
