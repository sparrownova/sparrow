...
from sparrow.twofactor import PARENT_FOR_DEFAULTS
from sparrow.utils.password import encrypt
...
def execute():
	...
	secrets = {
		key: value
		for key, value in sparrow.defaults.get_defaults_for(parent=OLD_PARENT).items()
	...
	defvalue_cases = sparrow.qb.terms.Case()
