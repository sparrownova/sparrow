...
def execute():
	...
	if sparrow.db.count("Communication", filters=dict(communication_type="Comment")) > 20000:
		sparrow.db.auto_commit_on_many_writes = True

	for comment in sparrow.get_all(
	...
	# clean up
	sparrow.db.delete("Communication", {"communication_type": "Comment"})
