...
class MetaTags:
	def __init__(self, path, context):
		...
		self.tags = sparrow._dict(self.context.get("metatags") or {})
	...
	def init_metatags_from_context(self):
		...
		if self.tags.get("image"):
			self.tags["image"] = sparrow.utils.get_url(self.tags["image"])

		self.tags["language"] = sparrow.local.lang or "en"
	...
	def set_metatags_from_website_route_meta(self):
		...
		if route_exists:
			website_route_meta = sparrow.get_doc("Website Route Meta", route)
