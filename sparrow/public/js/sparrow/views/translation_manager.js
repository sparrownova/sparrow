sparrow.views.TranslationManager = class TranslationManager {
	constructor(opts) {
	...
	get_translations_data() {
		return sparrow.db.get_list("Translation", {
	...
	update_translations({ source, translation_data = [] }) {
		...
		return sparrow
			.call({
				method: "sparrow.translate.update_translations_for_source",
