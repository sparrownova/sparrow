...
sparrow.provide("sparrow.widget");

sparrow.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
sparrow.widget.make_widget = (opts) => {
	const widget_class = sparrow.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = sparrow.widget.make_widget({
			...widget,
...
sparrow.widget.WidgetGroup = WidgetGroup;
sparrow.widget.SingleWidgetGroup = SingleWidgetGroup;
