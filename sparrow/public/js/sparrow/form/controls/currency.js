sparrow.ui.form.ControlCurrency = class ControlCurrency extends sparrow.ui.form.ControlFloat {
	...
	get_precision() {
		...
		if (typeof this.df.precision != "number" && !this.df.precision) {
			if (sparrow.boot.sysdefaults.currency_precision) {
				this.df.precision = sparrow.boot.sysdefaults.currency_precision;
			} else {
