...
sparrow.ui.form.ControlComment = class ControlComment extends sparrow.ui.form.ControlTextEditor {
	make_wrapper() {
		...
		// wrapper should point to sparrow-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".sparrow-control")
