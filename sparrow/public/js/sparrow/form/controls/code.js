sparrow.ui.form.ControlCode = class ControlCode extends sparrow.ui.form.ControlText {
	make_input() {
	...
	load_lib() {
		...
		if (sparrow.boot.developer_mode) {
			this.root_lib_path = "/assets/sparrow/node_modules/ace-builds/src-noconflict/";
		} else {
			this.root_lib_path = "/assets/sparrow/node_modules/ace-builds/src-min-noconflict/";
		}

		this.library_loaded = new Promise((resolve) => {
			sparrow.require(this.root_lib_path + "ace.js", () => {
