sparrow.ui.form.ControlFloat = class ControlFloat extends sparrow.ui.form.ControlInt {
	make_input() {
		super.make_input();
	...
	get_number_format() {
		var currency = sparrow.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(sparrow.boot.sysdefaults.float_precision, null);
	}
};

sparrow.ui.form.ControlPercent = sparrow.ui.form.ControlFloat;
