sparrow.ui.form.ControlButton = class ControlButton extends sparrow.ui.form.ControlData {
	can_write() {
	...
	set_label(label) {
		...
		label = (this.df.icon ? sparrow.utils.icon(this.df.icon) : "") + __(this.df.label);
