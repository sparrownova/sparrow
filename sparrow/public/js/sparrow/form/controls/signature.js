sparrow.ui.form.ControlSignature = class ControlSignature extends sparrow.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		sparrow.require("/assets/sparrow/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${sparrow.utils.icon("restriction", "md")}</i>
