		...
		methods: {
			fetch() {
				return new Promise((resolve) => {
					sparrow.model.clear_doc("Print Format", this.print_format_name);
					sparrow.model.with_doc("Print Format", this.print_format_name, () => {
						let print_format = sparrow.get_doc("Print Format", this.print_format_name);
						sparrow.model.with_doctype(print_format.doc_type, () => {
							this.meta = sparrow.get_meta(print_format.doc_type);
			...
			change_letterhead(letterhead) {
				return sparrow.db.get_doc("Letter Head", letterhead).then((doc) => {
					this.letterhead = doc;
				});
			},
		},
