...
from sparrow.utils import cint, convert_utc_to_system_timezone
from sparrow.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> sparrow._dict:
