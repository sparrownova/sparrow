...
class TestLogSettings(SparrowTestCase):
	...
	def test_delete_logs(self):
		...
		activity_log_count = sparrow.db.count("Activity Log", {"creation": ("<=", self.datetime.past)})
		error_log_count = sparrow.db.count("Error Log", {"creation": ("<=", self.datetime.past)})
		email_queue_count = sparrow.db.count("Email Queue", {"creation": ("<=", self.datetime.past)})
