...
// 		cy.window().its('sparrow').then(sparrow => {
// 			sparrow.call("sparrow.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/sparrow.model.utils.user_settings.save')
