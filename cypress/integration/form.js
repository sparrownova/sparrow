context("Form", () => {
	before(() => {
		...
		return cy
			...
			.its("sparrow")
			.then((sparrow) => {
				return sparrow.call("sparrow.tests.ui_test_helpers.create_contact_records");
			});
	});
	...
	it("create a new form", () => {
		...
		cy.intercept({
			method: "POST",
			url: "api/method/sparrow.desk.form.save.savedocs",
		}).as("form_save");
	...
	it("validates behaviour of Data options validations in child table", () => {
		...
		cy.get('.sparrow-control[data-fieldname="email_ids"]').as("table");
