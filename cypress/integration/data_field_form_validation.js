...
context("Data Field Input Validation in New Form", () => {
	...
	describe("Data Field Options", () => {
		...
		it("should validate URL", () => {
			validateField("url", "jkl", "https://sparrownova.com");
			validateField("url", "abcd.com", "http://google.com/home");
			validateField("url", "&&http://google.uae", "gopher://sparrownova.com");
			validateField("url", "ftt2:://google.in?q=news", "ftps2://sparrownova.com/__/#home");
